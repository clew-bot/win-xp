...
var NavLink = React71.forwardRef(({
  ...
  return (0, import_jsx_runtime69.jsx)(Component2, {
    ...
    ...navItemProps,
    ref,
    className: (0, import_classnames43.default)(className, bsPrefix, props.disabled && "disabled", meta.isActive && "active")
  });
});
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime88.jsxs)(import_jsx_runtime87.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react76.cloneElement)(children, triggerProps), (0, import_jsx_runtime86.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
